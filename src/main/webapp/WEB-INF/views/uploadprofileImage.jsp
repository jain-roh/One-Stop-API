      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <!-- Area Chart -->
           <form:form modelAttribute="business" method = "POST" enctype="multipart/form-data"
				class="form-horizontal">
<br/>                  
						<input type="file" id="photo"  name="photo" required="required" />
<br/>
                <input type="submit" value="Upload Image" class="btn btn-primary btn-user btn-block">
                 </form:form>
